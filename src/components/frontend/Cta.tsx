...
const CTASection: React.FC = () => {
  ...
  return (
    <section className="relative w-full py-24 bg-gradient-to-t from-black via-indigo-950 to-black overflow-hidden">
      ...
      >
        <div className="absolute top-1/2 left-1/2 w-60 h-12 border border-purple-300/30 rounded-full transform -translate-x-1/2 -translate-y-1/2 rotate-12" />
        <div className="absolute top-1/2 left-1/2 w-50 h-10 border border-indigo-300/20 rounded-full transform -translate-x-1/2 -translate-y-1/2 -rotate-6" />
      </motion.div>
      ...
      <motion.div
        ...
        animate={{ rotate: 360, x: [0, 50, 0, -50, 0], y: [50, 0, -50, 0, 50] }}
          ...
          <Card className="backdrop-blur-sm border border-cyan-400/20 bg-black/30 overflow-hidden">
            <CardContent className="p-6 md:p-8">
              ...
              >
                ...
                <motion.div className="flex gap-4 mb-8 flex-wrap justify-center" variants={itemVariants}>
                ...
                <motion.div className="flex gap-6 justify-center" variants={itemVariants}>
                  <Button variant="ghost" size="icon" className="rounded-full w-12 h-12 text-cyan-300 hover:text-white hover:bg-cyan-900/30 relative">
                    <Github size={22} />
                    <motion.div className="absolute inset-0 rounded-full border border-cyan-400/20" animate={{ rotate: 360 }} transition={{ duration: 10, repeat: Infinity, ease: "linear" }} />
                  </Button>
                  <Button variant="ghost" size="icon" className="rounded-full w-12 h-12 text-cyan-300 hover:text-white hover:bg-cyan-900/30 relative">
                    <Linkedin size={22} />
                    <motion.div className="absolute inset-0 rounded-full border border-cyan-400/20" animate={{ rotate: -360 }} transition={{ duration: 12, repeat: Infinity, ease: "linear" }} />
                  </Button>
                  <Button variant="ghost" size="icon" className="rounded-full w-12 h-12 text-cyan-300 hover:text-white hover:bg-cyan-900/30 relative">
                    <Twitter size={22} />
                    <motion.div className="absolute inset-0 rounded-full border border-cyan-400/20" animate={{ rotate: 360 }} transition={{ duration: 8, repeat: Infinity, ease: "linear" }} />
                  </Button>
                </motion.div>
              </motion.div>
            </CardContent>
